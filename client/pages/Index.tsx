  ...
  return (
    <main className="min-h-screen">
        ...
        <div className="container py-24">
          <div className="grid md:grid-cols-2 lg:grid-cols-[1.15fr_0.85fr] gap-12 lg:gap-16 xl:gap-24 items-start">
            ...
            >
              <h2
                id="about-heading"
                className="font-display text-3xl md:text-4xl text-cream uppercase inline-block relative after:absolute after:left-0 after:-bottom-2 after:h-1.5 after:w-24 after:bg-gold"
              >
                ABOUT US
              </h2>
            ...
            >
              <div className="relative w-full h-[380px] md:h-[520px] lg:h-[560px] rounded-2xl overflow-hidden shadow-xl ring-1 ring-white/20 transition-shadow hover:ring-gold/30 hover:shadow-2xl">
                <video
                  ...
                  title="Fili Coffee roastery video"
                  autoPlay
                  muted
                  loop
                  playsInline
      ...
      <section
        ...
        className="relative scroll-mt-24 overflow-hidden bg-coffee"
      >
        <div className="container py-24">
          ...
          <div className="space-y-14">
            <div>
              <h2 className="font-display text-3xl text-cream inline-block relative after:absolute after:left-0 after:-bottom-1.5 after:h-1 after:w-20 after:bg-gold">
                What we serve you
              </h2>
